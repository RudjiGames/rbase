...
linux-debug32: gmake-linux
	make -R -C ../.build/linux/gcc/rbase/projects config=debug32
linux-release32: gmake-linux
	make -R -C ../.build/linux/gcc/rbase/projects config=release32
...
mingw-gcc-debug32: gmake-mingw-gcc
	make -R -C ../.build/windows/mingw-gcc/rbase/projects config=debug32
mingw-gcc-release32: gmake-mingw-gcc
	make -R -C ../.build/windows/mingw-gcc/rbase/projects config=release32
mingw-gcc-debug64: gmake-mingw-gcc
	make -R -C ../.build/windows/mingw-gcc/rbase/projects config=debug64
mingw-gcc-release64: gmake-mingw-gcc
	make -R -C ../.build/windows/mingw-gcc/rbase/projects config=release64
...
mingw-clang-debug32: gmake-mingw-clang
	make -R -C ../.build/windows/mingw-clang/rbase/projects config=debug32
mingw-clang-release32: gmake-mingw-clang
	make -R -C ../.build/windows/mingw-clang/rbase/projects config=release32
mingw-clang-debug64: gmake-mingw-clang
	make -R -C ../.build/windows/mingw-clang/rbase/projects config=debug64
mingw-clang-release64: gmake-mingw-clang
	make -R -C ../.build/windows/mingw-clang/rbase/projects config=release64
...
../.build/osx/clang/rbase/projects:
	$(GENIE) --file=genie/genie.lua --gcc=osx gmake
osx-debug64: ../.build/osx/clang/rbase/projects
	make -R -C ../.build/osx/clang/rbase/projects config=debug64
osx-release64: ../.build/osx/clang/rbase/projects
	make -R -C ../.build/osx/clang/rbase/projects config=release64
